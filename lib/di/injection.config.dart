...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingletonAsync<_i4.SharedPreferences>(() => appModule.sharedPref);
    gh.singleton<_i5.DioClientWrapper>(
        () => _i5.DioClientWrapper(gh<_i3.FlutterSecureStorage>()));
    gh.singletonAsync<_i6.SharedPreferencesService>(() async =>
        _i6.SharedPreferencesService(await getAsync<_i4.SharedPreferences>()));
